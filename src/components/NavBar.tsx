...
export const NavBar = () => {
    ...
    return (
        <NavContainer DM={DarkMode} Menu={menu}>
            ...
            </Controller>
            {
                menu ? <>
                    <MenuContainer Menu={menu}>
                        ...
                        <BsPerson size='40' color={DarkMode ? Blanco : Negro} className='menuicons' onClick={closeMenu} />
                        <IoIosList size='35' color={DarkMode ? Blanco : Negro} className='menuicons' onClick={closeMenu} />
                        <BiBrain size='40' color={DarkMode ? Blanco : Negro} className='menuicons' onClick={closeMenu} />
                        <VscTools size='36' color={DarkMode ? Blanco : Negro} className='menuicons' onClick={closeMenu} />
                        <MdOutlineGames size='35' color={DarkMode ? Blanco : Negro} className='menuicons' onClick={closeMenu} />
                        <MdOutlineConnectWithoutContact size='35' color={DarkMode ? Blanco : Negro} className='menuicons' onClick={closeMenu} />
            ...
            <MenuContainer>
                <IoHomeOutline size='38' color={DarkMode ? Blanco : Negro} className='menuicons' onClick={closeMenu} />
                <BsPerson size='48' color={DarkMode ? Blanco : Negro} className='menuicons' onClick={closeMenu} />
                <IoIosList size='38' color={DarkMode ? Blanco : Negro} className='menuicons' onClick={closeMenu} />
                <BiBrain size='45' color={DarkMode ? Blanco : Negro} className='menuicons' onClick={closeMenu} />
                <VscTools size='40' color={DarkMode ? Blanco : Negro} className='menuicons' onClick={closeMenu} />
                <MdOutlineGames size='40' color={DarkMode ? Blanco : Negro} className='menuicons' onClick={closeMenu} />
                <MdOutlineConnectWithoutContact size='40' color={DarkMode ? Blanco : Negro} className='menuicons' onClick={closeMenu} />
            </MenuContainer>
        </NavContainer>
    )
}
